...
class ExtraNetworksPageLora(ui_extra_networks.ExtraNetworksPage):
    ...
    # CUSTOM (Forge Neo): the folder chips and tree follow the active folder, so
    # picking "krea2" does not still list every Anima subfolder.
    def directories_for_browsing(self):
        return networks.active_lora_dirs()
