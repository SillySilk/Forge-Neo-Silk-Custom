...
canvas_head = "".join((web_css("canvas.css"), web_js("shapes.js"), web_js("canvas.js")))
...
class ForgeCanvas:
    def __init__(self, no_upload=False, no_scribbles=False, no_shapes=False, contrast_scribbles=False, height=None, scribble_color="#000000", scribble_color_fixed=False, scribble_width=25, scribble_width_fixed=False, scribble_alpha=100, scribble_alpha_fixed=False, scribble_softness=0, scribble_softness_fixed=False, scribble_rotation=0, scribble_rotation_fixed=False, visible=True, numpy=False, initial_image=None, elem_id=None, elem_classes=None):
